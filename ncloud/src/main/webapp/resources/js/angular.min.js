(function (T, V, s) {
		...
		if (a) {
			...
			if (A(b))
				for (var f = a.length = 0; f < b.length; f++)
					e = Ba(b[f], null, c, d), J(b[f]) && (c.push(b[f]), d.push(e)), a.push(e);
			else {
				var g = a.$$hashKey;
				...
				for (f in b)
					b.hasOwnProperty(f) && (e = Ba(b[f], null, c, d), J(b[f]) && (c.push(b[f]), d.push(e)), a[f] = e);
				qc(a, g)
			}
		} else if (a = b)
			A(b) ? a = Ba(b, [], c, d) : ea(b) ? a = new Date(b.getTime()) : Ua(b) ? (a = new RegExp(b.source, b.toString().match(/[^\/]*$/)[0]), a.lastIndex = b.lastIndex) : J(b) && (e = Object.create(Object.getPrototypeOf(b)), a = Ba(b, e, c, d));
		return a
	}
	function oa(b, a) {
		if (A(b)) {
	...
	function fa(b, a) {
		...
		if (c == typeof a && "object" == c)
			if (A(b)) {
				...
				if (Va(b) || Va(a) || Ta(b) || Ta(a) || A(a) || ea(a) || Ua(a))
					return !1;
				c = {};
				for (d in b)
					if ("$" !== d.charAt(0) && !F(b[d])) {
		...
		this.$get = ["$window", "$location", "$rootScope", function (a, c, d) {
				...
				function f(b) {
					if (b) {
						...
						var c;
						c = g.yOffset;
						F(c) ? c = c() : rc(c) ? (c = c[0], c = "fixed" !== a.getComputedStyle(c).position ? 0 : c.getBoundingClientRect().bottom) : U(c) || (c = 0);
	...
	function sf(b, a, c, d) {
		...
		m.url = function (a, c, e) {
			...
			if (a) {
				...
				if (!d.history || g && f) {
					...
					v[c ? "replaceState" : "pushState"](e, "", a), h(), C = M;
				return m
			}
		...
		m.cookies = function (a, b) {
			...
			g;
			if (a)
				b === s ? r.cookie = encodeURIComponent(a) + "=;path=" + hb + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : K(b) && (d = (r.cookie = encodeURIComponent(a) + "=" + encodeURIComponent(b) + ";path=" + hb).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!"));
			else {
				if (r.cookie !== B)
					for (B = r.cookie, d = B.split("; "), Fa = {}, f = 0; f < d.length; f++)
						e = d[f], g = e.indexOf("="), 0 < g && (a = k(e.substring(0, g)), Fa[a] === s && (Fa[a] = k(e.substring(g + 1))));
				return Fa
			}
		};
	...
	function Bc(b, a) {
		...
		this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, d, u, p, I, R, x, M, C) {
				...
				function Q(a, b, c, d, e) {
					...
					q(a, function (b, c) {
						b.nodeType == ab && b.nodeValue.match(/\S+/) && (a[c] = G(b).wrap("<span></span>").parent()[0])
					});
					var f = X(a, b, a, c, d, e);
					Q.$$addScopeClass(a);
					var g = null;
				...
				function X(a, b, c, d, e, f) {
					function g(a, c, d, e) {
						...
						w;
						if (p)
							for (w = Array(c.length), n = 0; n < h.length; n += 3)
								f = h[n], w[f] = c[f];
						else
							w = c;
						n = 0;
						for (m = h.length; n < m; )
							l = w[h[n++]], c = h[n++], f = h[n++], c ? (c.scope ? (k = a.$new(), Q.$$addScopeInfo(G(l), k)) : k = a, t = c.transcludeOnThisElement ? $(a, c.transclude, e, c.elementTranscludeOnThisElement) : !c.templateOnThisElement && e ? e : !e && b ? $(a, b) : null, c(f, k, l, d, t)) : f && f(a, l.childNodes, s, e)
					}
				...
				function W(a, b, c, d, e) {
					...
					case ma:
						...
						if (K(a) && "" !== a)
							for (; l = g.exec(a); )
								k = va(l[2]), z(b, k, "C", d, e) && (c[k] = N(l[3])), a = a.substr(l.index + l[0].length);
						break;
					case ab:
						ia(b, a.nodeValue);
						break;
					case 8:
						try {
							if (l = f.exec(a.nodeValue))
								k = va(l[1]), z(b, k, "M", d, e) && (c[k] = N(l[2]))
						} catch (u) {}
					}
					b.sort(xa);
					return b
				...
				function B(a, d, e, f, g, h, k, n, m) {
					...
					function x(a, c, f, g, h) {
						...
						if (R) {
							...
							q(C.$$isolateBindings = R.$$isolateBindings, function (a, d) {
								var e = a.attrName,
								f = a.optional,
								g,
								h,
						...
						for (m = k.length; g < m; g++)
							t = k[g], Xc(t, t.isolateScope ? C : c, S, W, t.require && M(t.directiveName, t.require, S, H), ib);
						var Zb = c;
						R && (R.template || null === R.templateUrl) && (Zb = C);
						a && a(Zb, f.childNodes, s, h);
						for (g = n.length - 1; 0 <= g; g--)
							t = n[g], Xc(t, t.isolateScope ? C : c, S, W, t.require && M(t.directiveName, t.require, S, H), ib)
					}
					m = m || {};
					for (var C = -Number.MAX_VALUE, H, I = m.controllerDirectives, $, R = m.newIsolateScopeDirective, X = m.templateDirective, Ga = m.nonTlbTranscludeDirective, z = !1, Yb = !1, D = m.hasElementTranscludeDirective, y = e.$$element = G(d), L, ia, E, gb = f, xa, qa = 0, O = a.length; qa < O; qa++) {
						L = a[qa];
						var P = L.$$start,
						jb = L.$$end;
						P && (y = S(d, P, jb));
						...
						if (C > L.priority)
							break;
						if (E = L.scope)
							L.templateUrl || (J(E) ? (Oa("new/isolated scope", R || H, L, y), R = L) : Oa("new/isolated scope", R, L, y)), H = H || L;
						ia = L.name;
						!L.templateUrl && L.controller && (E = L.controller, I = I || {}, Oa("'" + ia + "' controller", I[ia], L, y), I[ia] = L);
						if (E = L.transclude)
							z = !0, L.$$tlb || (Oa("transclusion", Ga, L, y), Ga = L), "element" == E ? (D = !0, C = L.priority, E = y, y = e.$$element = G(V.createComment(" " + ia + ": " + e[ia] + " ")), d = y[0], U(g, Za.call(E, 0), d), gb = Q(E, f, C, h && h.name, {
						...
						if (L.template)
							if (Yb = !0, Oa("template", X, L, y), X = L, E = F(L.template) ? L.template(y, e) : L.template, E = Yc(E), L.replace) {
								...
								y.html(E);
						if (L.templateUrl)
							Yb = !0, Oa("template", X, L, y), X = L, L.replace && (h = L), x = Xb(a.splice(qa, a.length - qa), y, e, g, z && gb, k, n, {
							...
							try {
								xa = L.compile(y, e, gb),
								F(xa) ? w(null, xa, P, jb) : xa && w(xa.pre, xa.post, P, jb)
							} catch (ac) {
								c(ac, ta(y))
							}
				...
				function Xb(a, b, c, e, f, g, h, k) {
					...
					d(M).then(function (d) {
						...
						if (t.replace) {
							...
							w = d[0];
							if (1 != d.length || w.nodeType !== ma)
								throw da("tplrt", t.name, M);
							d = {
								$attr: {}
							};
							U(e, b, w);
				...
				$b.prototype = {
					...
					$set: function (a, b, d, e) {
						...
						if ("a" === g && "href" === a || "img" === g && "src" === a)
							...
							for (var g = "", h = N(b), l = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, l = /\s/.test(h) ? l : /(,)/, h = h.split(l), l = Math.floor(h.length / 2), k = 0; k < l; k++)
								var n = 2 * k, g = g + C(N(h[n]), !0), g = g + (" " + N(h[n + 1]));
							h = N(h[2 * k]).split(/\s/);
							g += C(N(h[0]), !0);
							2 === h.length && (g += " " + N(h[1]));
							this[a] = b = g
				...
				Q.$$addBindingClass = m ? function (a) {
				 ...
				 : D;
				Q.$$addScopeInfo = m ? function (a, b, c, d) {
	...
	function Pe() {
		var b = this.defaults = {
			...
			transformRequest: [function (a) {
					return J(a) && "[object File]" !== Aa.call(a) && "[object Blob]" !== Aa.call(a) && "[object FormData]" !== Aa.call(a) ? $a(a) : a
				}
			],
			headers: {
				common: {
		...
		this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (d, e, f, g, h, l) {
				...
				function m(c, f) {
					...
					z(H) && ((H = ed(c.url) ? e.cookies()[c.xsrfCookieName || b.xsrfCookieName] : s) && (Q[c.xsrfHeaderName || b.xsrfHeaderName] = H), d(c.method, q, f, l, Q, c.timeout, c.withCredentials, c.responseType));
					return M
				}
				function r(a, b) {
					if (!b)
		...
		this.$get = ["$parse", "$exceptionHandler", "$sce", function (c, d, e) {
				...
				function g(f, g, v, t) {
					...
					for (var p, I, q = 0, x = [], M = [], C = f.length, H = [], Q = []; q < C; )
						if (-1 != (p = f.indexOf(b, q)) && -1 != (I = f.indexOf(a, p + h)))
							q !== p && H.push(w(f.substring(q, p))), q = f.substring(p + h, I), x.push(q), M.push(c(q, u)), q = I + l, Q.push(H.length), H.push("");
						else {
					...
					$watchCollection: function (a, b) {
						function c(a) {
							...
							if (!z(e)) {
								if (J(e))
									if (Sa(e))
										for (f !== n && (f = n, v = f.length = 0, k++), a = e.length, v !== a && (k++, f.length = v = a), b = 0; b < a; b++)
											h = f[b], g = e[b], d = h !== h && g !== g, d || h === g || (k++, f[b] = g);
									else {
										f !== r && (f = r = {}, v = 0, k++);
										a = 0;
										for (b in e)
											e.hasOwnProperty(b) && (a++, g = e[b], h = f[b], b in f ? (d = h !== h && g !== g, d || h === g || (k++, f[b] = g)) : (v++, f[b] = g, k++));
										if (v > a)
											for (b in k++, f)
												e.hasOwnProperty(b) || (v--, delete f[b])
									}
								else
									f !== e && (f = e, k++);
								return k
							...
							a: do {
								if (k = w.$$watchers)
									for (m = k.length; m--; )
										try {
											if (b = k[m])
												if ((f = b.get(w)) !== (h = b.last) && !(b.eq ? fa(f, h) : "number" === typeof f && "number" === typeof h && isNaN(f) && isNaN(h)))
													n = !0, d = b, b.last = b.eq ? Ba(f, null) : f, b.fn(f, h === v ? f : h, w), 5 > q && (s = 4 - q, S[s] || (S[s] = []), S[s].push({
								...
								if (!(k = w.$$childHead || w !== this && w.$$nextSibling))
									for (; w !== this && !(k = w.$$nextSibling); )
										w = w.$parent
							} while (w = k);
							if ((n || p.length) && !q--)
								throw u.$$phase = null, c("infdig", a, S);
						} while (n || p.length);
						for (u.$$phase = null; I.length; )
							try {
								I.shift()()
							} catch (E) {
								g(E)
	...
	function Ha(b, a, c, d, e) {
		...
		case "object":
			...
			if ("object" === g) {
				for (h in a)
					if (e = a[h], !F(e) && !z(e) && (f = "$" === h, !Ha(f ? b : b[h], e, c, f, f)))
						return !1;
				return !0
			}
			return c(b, a);
	...
	function pd(b) {
		...
		return function (c, e, f) {
			...
			K(c) && (c = Of.test(c) ? aa(c) : a(c));
			U(c) && (c = new Date(c));
			if (!ea(c))
				return c;
			for (; e; )
				(k = Pf.exec(e)) ? (h = Ya(h, k, 1), e = h.pop()) : (h.push(e), e = null);
	...
	function Kf() {
		return function (b, a) {
			U(b) && (b = b.toString());
			return A(b) || K(b) ? (a = Infinity === Math.abs(Number(a)) ? Number(a) : aa(a)) ? 0 < a ? b.slice(0, a) : b.slice(a) : K(b) ? "" : [] : b
		}
	}
	function rd(b) {
	...
	q({
		...
		P.prototype[c] = function (c, e, f) {
			for (var g, h = 0, l = this.length; h < l; h++)
				z(g) ? (g = a(this[h], c, e, f), B(g) && (g = G(g))) : Lc(g, a(this[h], c, e, f));
			return B(g) ? g : this
		};
	...
	bb.$$annotate = function (a, c, d) {
		...
		if ("function" === typeof a) {
			if (!(e = a.$inject)) {
				...
				if (a.length) {
					if (c)
						throw K(d) && d || (d = a.name || rf(a)), Da("strictdi", d);
			...
			A(a) ? (c = a.length - 1, La(a[c], "fn"), e = a.slice(0, c)) : La(a, "fn", !0);
		return e
	};
	var Xf = E("$animate"),
			...
			this.$$runValidators = function (a, c, d) {
				...
				(function () {
					...
					if (u === s)
						...
						return u || (q(p.$validators, function (a, c) {
								g(c, null)
					...
					return function (a, f, g, k, m) {
						...
						a.$watchCollection(r, function (g) {
							...
							if (Sa(g))
								...
								F = [];
								for (J in g)
									g.hasOwnProperty(J) && "$" != J.charAt(0) && F.push(J);
								F.sort()
							}
							y = F.length;
							J = Array(y);
							for (k = 0; k < y; k++)
								if (D = g === F ? k : F[k], Q = g[D], x = r(D, Q, k), v[x])
									A = v[x], delete v[x], z[x] = A, J[k] = A;
								else {
									if (z[x])
	...
	ze = Ia({
			...
			link: function (a, c, d, e, f) {
				if (!f)
					throw E("ngTransclude")("orphan", ta(c));
				f(function (a) {
					c.empty();
					c.append(a)
				})
					...
					function r(e, f, g) {
						...
						function r() {
							...
							for (D = c.length; x < D; x++) {
								...
								for (F = l.length; C < F; C++)
									d = l[C], (u = s[C + 1]) ? (N = u.element, u.label !== d.label && (m(S, u.label, !1), m(S, d.label, !0), N.text(u.label = d.label), N.prop("label", u.label)), u.id !== d.id && N.val(u.id = d.id), N[0].selected !== d.selected && (N.prop("selected", u.selected = d.selected), Qa && N.prop("selected", u.selected))) : ("" === d.id && w ? U = w : (U = z.clone()).val(d.id).prop("selected", d.selected).attr("selected", d.selected).prop("label", d.label).text(d.label), s.push(u = {
												element: U,
												label: d.label,
												id: d.id,
												selected: d.selected
						...
						e.$watchCollection(function () {
							...
							if (a && A(a)) {
								...
								for (d in c = {}, a)
									a.hasOwnProperty(d) && (c[d] = h(y, d, a[d]));
							return c
						}, l);
			...
			link: function (a, c, d, e) {
				if (e) {
					...
					d.$observe("pattern", function (a) {
						...
						if (a && !a.test)
							throw E("ngPattern")("noregexp", g, a, ta(c));
						f = a || s;
						e.$validate()
					});
